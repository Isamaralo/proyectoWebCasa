...
<div class="container">
  <CENTER ><h2>DESPRENDIMIENTO</h2>
    ...
    <tbody>
    <tr>
        <td><img src="img/desprendimiento-test.jpg"  class="img-rounded" alt="Cinque Terre" width="404" height="236">DESCRIPCION<br>${desprendimiento.descripcion}</td>
      ...
      <tr>
        ...
        <td><center>CAUSAS<br>${desprendimiento.causa}</center></td>
      </tr>
      <tr>
        <td><center>TRATAMIENTO<br>${desprendimiento.tratamiento}</center></td>
        
       
      </tr>
      <tr>
        <td><center>SINTOMAS</center></td>
     	<c:forEach items="${desprendimiento.lista_sintomas}" 
        var="sintoma">
