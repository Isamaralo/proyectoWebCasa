  ...
  <div class="container-fluid">
    ...
    <button type="button" class="btn btn-info">
        <a href="busqueda.html">  
            <span class="glyphicon glyphicon-search"></span> BښSQUEDA</a>
    </button>
  </p>
      </ul>
    </div>
...
<div class="container">
  <CENTER ><h2>CONJUNTIVITIS</h2>
    ...
    <tbody>
    <tr>
        <td><img src="img/conjuntivitis.jpg"  class="img-rounded" alt="Cinque Terre" width="404" height="236">DESCRIPCION<br>${conjuntivitis.descripcion}</td>
      ...
      <tr>
        ...
        <td><center>CAUSAS<br>${conjuntivitis.causa}</center></td>
      </tr>
      <tr>
        <td><center>TRATAMIENTO<br>${conjuntivitis.tratamiento}</center></td>
        
       
      </tr>
      <tr>
        <td><center>SINTOMAS</center></td>
     	<c:forEach items="${conjuntivitis.lista_sintomas}" 
        var="sintoma">
