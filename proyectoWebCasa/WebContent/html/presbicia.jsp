...
<div class="container">
  <CENTER ><h2>PRESBICIA</h2>
    ...
    <tbody>
    <tr>
        <td><img src="img/presbicia-test.jpg"  class="img-rounded" alt="Cinque Terre" width="404" height="236">DESCRIPCION<br>${presbicia.descripcion}</td>
      ...
      <tr>
          ...
          <td><center>CAUSAS<br>${presbicia.causa}</center></td>
      </tr>
      <tr>
          <td><center>TRATAMIENTO<br>${presbicia.tratamiento}</center></td>
        
       
      </tr>
      <tr>
          <td><center>SINTOMAS<br>
     		<c:forEach items="${presbicia.lista_sintomas}" 
        var="sintoma">
