...
<div class="container">
  <CENTER ><h2>QUERATOCONO</h2>
    ...
    <tbody>
    <tr>
        <td><img src="img/tratamiento_queratocono.jpg"  class="img-rounded" alt="Cinque Terre" width="404" height="236">DESCRIPCION<br>${queratocono.descripcion}</td>
      ...
      <tr>
        ...
        <td><center>CAUSAS<br>${queratocono.causa}</center></td>
      </tr>
      <tr>
        <td><center>TRATAMIENTO<br>${queratocono.tratamiento}</center></td>
