...
<div class="container">
  <CENTER ><h2>ESTRABISMO</h2>
    ...
    <tbody>
    <tr>
        <td><img src="img/estrabismo-test.jpg"  class="img-rounded" alt="Cinque Terre" width="404" height="336">DESCRIPCION<br>${estrabismo.descripcion}</td>
      ...
      <tr>
        ...
        <td><center>CAUSAS<br>${estrabismo.causa}</td>
      </tr>
      <tr>
        <td><center>TRATAMIENTO<br>${estrabismo.tratamiento}</td>
        
       
      </tr>
      <tr>
        <td><center>SINTOMAS</td>
     	<c:forEach items="${estrabismo.lista_sintomas}" 
        var="sintoma">
